...
//       // const zIndex = pos === 'center' ? 5 : Math.abs(centerIndex - index) + 1;

//       //   return [pos, { x, scale: Math.max(scale as number, 0.2) }, zIndex];
//     };
//     return acc;
...
//   return (
//     <>
//       <div className="w-screen h-[40vh] max-sm:h-[35vh] max-xsm:h-[30vh] flex flex-col items-center relative overflow-x-hidden ">
...
//               className={`w-[20%] max-sm:w-[35%] h-[35vh] max-sm:h-[30vh] max-xsm:h-[25vh] cursor-pointer `}
//             >
//               <Image
//                 fill
//                 src={image}
