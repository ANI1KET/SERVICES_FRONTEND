          ...
          {data?.pages.map((page, pageIndex) =>
            page.map((item, index: number) => (
              ...
              >
                ...
                <div className="w-[20vw] max-sm:w-[50vw] max-xsm:w-screen grid grid-rows-2 grid-cols-2 gap-1 p-1 border-r-[1px] border-l-[1px] border-b-[1px] border-black rounded-b-md">
                  <p
                    className={`row-span-1 col-span-1 text-xl `}
                    title={`Minimum Person : ${item.mincapacity}\nMaximum Person : ${item.maxcapacity}`}
                  >
