...
} from '../../../../lib/utils/FetchCategoryPlaces';
...
const SearchForm: React.FC = () => {
  ...
  return (
    <form
      className="max-sm:hidden grid grid-cols-9 gap-1 w-full h-1/2 relative"
      onSubmit={handleSubmit(onSubmit)}
    >
      <div className="col-span-1 grid grid-flow-col place-content-center place-items-center border-r-[1px] border-black h-full cursor-pointer group ">
        <p>Filter</p>
        <svg
      ...
      <div className="col-span-2 place-content-center border-r-[1px] border-black">
        <FormControl
          fullWidth
          size="small"
          sx={{
      ...
      <div className="col-span-1 space-y-3 place-content-center text-center bg-black rounded-br-lg ">
